...
layout: page
lang: en
permalink: /tutorial-upstream-proxy/
title: "Tutorial: authenticate behind a corporate proxy"
eyebrow: "Tutorial"
description: "Forward local traffic through an authenticated corporate proxy — no separate authentication helper needed."
---
...
<p class="note-title">🎯 What you'll set up</p>
...
<div class="note" markdown="1">
<p class="note-title">🧩 Who this is for</p>
...
![HttpStackLens forwarding to an upstream proxy with Windows authentication.]({{ "/assets/img/forward-proxy-server-with-windows-authentication.png" | relative_url }})
...
![Editing the upstream proxy from the Web UI.]({{ "/assets/img/screenshots/upstream-settings.png" | relative_url }})

## 3. Add Windows authentication

<div class="note warn" markdown="1">
<p class="note-title">🪟 Windows only</p>
...
![The 401/407 compatibility handshake with the upstream proxy.]({{ "/assets/img/upstream-proxy-401-compatibility-flow.png" | relative_url }})
...
<div class="note" markdown="1">
<p class="note-title">🐳 Containers & Docker</p>
