...
layout: page
lang: fr
permalink: /fr/tutorial-https-decrypt/
title: "Tutoriel : déboguer le HTTPS & nettoyer les certificats"
eyebrow: "Tutoriel"
description: "Activez le déchiffrement HTTPS, inspectez le trafic chiffré, puis retirez chaque certificat de débogage pour garder votre magasin de confiance intact."
---
...
<p class="note-title">⚠️ Vous installez un CA racine de confiance</p>
...
![Bascule du déchiffrement HTTPS depuis l'interface web.]({{ "/assets/img/screenshots/decrypt-toggle.png" | relative_url }})
...
<p class="note-title">🏷️ Comment le nettoyage reste sûr</p>
...
![Un échange HTTPS déchiffré, entièrement lisible dans l'interface.]({{ "/assets/img/screenshots/decrypted-inspect.png" | relative_url }})
...
![Le récapitulatif de nettoyage : CA racines et certificats de domaine retirés.]({{ "/assets/img/screenshots/cert-cleanup.png" | relative_url }})

<div class="note warn" markdown="1">
<p class="note-title">🖥️ Note par plateforme</p>
...
<p class="note-title">✅ OS propre</p>
