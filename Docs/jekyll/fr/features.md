...
eyebrow: "Référence"
description: "Ce que HttpStackLens sait faire aujourd'hui, et comment chaque brique s'articule."
---
...
![La liste des requêtes en direct, les plus récentes en premier.]({{ "/assets/img/screenshots/request-list.png" | relative_url }})
...
<p class="note-title">🔐 Sûr par conception</p>
...
[tutoriel de déchiffrement HTTPS]({{ "/fr/tutorial-https-decrypt/" | relative_url }}).
</div>

![Une réponse HTTPS déchiffrée, en-têtes et corps en clair.]({{ "/assets/img/screenshots/decrypted-body.png" | relative_url }})
...
![Requête et réponse côte à côte, avec bascule de focus.]({{ "/assets/img/screenshots/split-panes.png" | relative_url }})
...
[tutoriel dédié au proxy d'entreprise]({{ "/fr/tutorial-upstream-proxy/" | relative_url }}).

![Le flux de compatibilité 401/407 du proxy amont.]({{ "/assets/img/upstream-proxy-401-compatibility-flow.png" | relative_url }})
...
![La structure du datagramme .capture sur disque.]({{ "/assets/img/capture-file-format-datagram.png" | relative_url }})
...
<div class="note" markdown="1">
<p class="note-title">📱 Déboguer un container ou un appareil mobile</p>
...
<p class="note-title">🔧 Deux contrôles d'accès distincts</p>
