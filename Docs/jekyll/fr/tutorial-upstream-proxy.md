...
layout: page
lang: fr
permalink: /fr/tutorial-upstream-proxy/
title: "Tutoriel : s'authentifier derrière un proxy d'entreprise"
eyebrow: "Tutoriel"
description: "Relayer le trafic local à travers un proxy d'entreprise authentifié — sans assistant d'authentification séparé."
---
...
<p class="note-title">🎯 Ce que vous allez mettre en place</p>
...
<div class="note" markdown="1">
<p class="note-title">🧩 À qui ça s'adresse</p>
...
![HttpStackLens relayant vers un proxy amont avec authentification Windows.]({{ "/assets/img/forward-proxy-server-with-windows-authentication.png" | relative_url }})
...
![Édition du proxy amont depuis l'interface web.]({{ "/assets/img/screenshots/upstream-settings.png" | relative_url }})

## 3. Ajouter l'authentification Windows

<div class="note warn" markdown="1">
<p class="note-title">🪟 Windows uniquement</p>
...
![Le handshake de compatibilité 401/407 avec le proxy amont.]({{ "/assets/img/upstream-proxy-401-compatibility-flow.png" | relative_url }})
...
<div class="note" markdown="1">
<p class="note-title">🐳 Conteneurs & Docker</p>
