...
eyebrow: "Guide"
description: "Build the binary, launch the proxy and open the Web UI in a few minutes."
---
...
<p class="note-title">🔑 Default ports</p>
...
- [🏢 Corporate proxy]({{ "/tutorial-upstream-proxy/" | relative_url }}) — sit behind an authenticated
  corporate proxy without a separate authentication helper.
- [🔍 Debug HTTPS & clean up]({{ "/tutorial-https-decrypt/" | relative_url }}) — decrypt HTTPS, inspect
