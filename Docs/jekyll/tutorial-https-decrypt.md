...
layout: page
lang: en
permalink: /tutorial-https-decrypt/
title: "Tutorial: debug HTTPS & clean up certificates"
eyebrow: "Tutorial"
description: "Turn on HTTPS decryption, inspect encrypted traffic, then remove every debug certificate so your OS trust store stays clean."
---
...
<p class="note-title">⚠️ You are installing a trusted root CA</p>
...
![Toggling HTTPS decryption from the Web UI.]({{ "/assets/img/screenshots/decrypt-toggle.png" | relative_url }})
...
<p class="note-title">🏷️ How cleanup stays safe</p>
...
![A decrypted HTTPS exchange, fully readable in the UI.]({{ "/assets/img/screenshots/decrypted-inspect.png" | relative_url }})
...
![The cleanup summary: root CAs and domain leaves removed.]({{ "/assets/img/screenshots/cert-cleanup.png" | relative_url }})

<div class="note warn" markdown="1">
<p class="note-title">🖥️ Platform note</p>
