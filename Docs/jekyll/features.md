...
title: "Features"
eyebrow: "Reference"
description: "What HttpStackLens can do today, and how each piece fits together."
---
...
![The live request list, newest first.]({{ "/assets/img/screenshots/request-list.png" | relative_url }})
...
<p class="note-title">🔐 Safe by design</p>
...
[HTTPS decryption tutorial]({{ "/tutorial-https-decrypt/" | relative_url }}).
</div>

![A decrypted HTTPS response, headers and body in the clear.]({{ "/assets/img/screenshots/decrypted-body.png" | relative_url }})
...
![Request and response side by side, with a focus toggle.]({{ "/assets/img/screenshots/split-panes.png" | relative_url }})
...
[corporate-proxy tutorial]({{ "/tutorial-upstream-proxy/" | relative_url }}).

![The 401/407 upstream-proxy compatibility flow.]({{ "/assets/img/upstream-proxy-401-compatibility-flow.png" | relative_url }})
...
![The on-disk .capture datagram layout.]({{ "/assets/img/capture-file-format-datagram.png" | relative_url }})
...
<div class="note" markdown="1">
<p class="note-title">📱 Debugging a container or a mobile device</p>
...
<p class="note-title">🔧 Two separate access controls</p>
